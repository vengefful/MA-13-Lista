...
\begin{problem}{2.3.14}
    \phantomsection
    \label{prob:2.3.14}
    Em um triângulo \textit{ABC}, sabemos que Â é igual à oitava parte da medida do ângulo obtuso formado pelas bissetrizes internas dos vértices \textit{B} e \textit{C}. Calcule a medida do ângulo $\angle A$.   
\end{problem}
